...
export default function ReporterProfile({ onBack, onLogoClick, reports, onToggleLang }) {
  ...
  return (
    <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, overflowY: "auto", background: "#0a0f1a", willChange: "scroll-position" }}>
      {/* Header */}
      <div className="desktop-center-header" style={{ position: "sticky", top: 0, zIndex: 10, padding: "12px 16px", display: "flex", alignItems: "center", gap: "10px", background: "#0a0f1a", borderBottom: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 1px 0 rgba(255,255,255,0.02), 0 4px 20px rgba(0,0,0,0.2)", transform: "translateZ(0)" }}>
