...
export default function HeatmapView({ onBack, onLogoClick, onToggleLang }) {
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "var(--bg)", overflow: "hidden" }}>
      <div style={{ padding: "12px 16px", display: "flex", alignItems: "center", gap: "8px", background: "rgba(10,15,26,0.95)", backdropFilter: "blur(20px) saturate(1.5)", WebkitBackdropFilter: "blur(20px) saturate(1.5)", borderBottom: "1px solid var(--border)", boxShadow: "0 1px 0 var(--border), 0 4px 16px rgba(0,0,0,0.15)", zIndex: 10, flexShrink: 0 }}>
      ...
      <div style={{ flex: 1, position: "relative" }}>
        ...
        {stats && !loading && (
          <div style={{ position: "absolute", bottom: 16, left: 16, right: 16, zIndex: 900, background: "rgba(10,15,26,0.92)", backdropFilter: "blur(12px)", borderRadius: "var(--radius-lg)", border: "1px solid var(--border)", padding: "16px", maxHeight: "40vh", overflowY: "auto" }}>
