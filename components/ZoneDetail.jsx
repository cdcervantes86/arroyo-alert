...
export default function ZoneDetail({ zone, severity, reports, onBack, onReport, onUpvote, pushSupported, isSubscribed, onSubscribe, onUnsubscribe, onLogoClick }) {
  ...
  return (
    <>
      ...
      <div className="screen-enter" style={{ height: "100dvh", display: "flex", flexDirection: "column", background: "var(--bg)", overflow: "hidden" }}>
        ...
        <div style={{ padding: "20px", flex: 1, overflowY: "auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", paddingBottom: 260 }}>
            {reports.map((r, i) => {
