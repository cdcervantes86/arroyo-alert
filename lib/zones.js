...
export const ZONES = [
  ...
  { id:  1, name: "Don Juan",       area: "Sur / Soledad",            lat: 10.934, lng: -74.7878, desc: "7.9 km — Caudal 85 m³/s — 11 muertes registradas", descEn: "7.9 km — Flow 85 m³/s — 11 recorded deaths" },
  { id:  2, name: "El Salao",       area: "Soledad / Ferrocarril",    lat: 10.9099, lng: -74.7986, desc: "9.2 km — El más largo — 7 muertes registradas", descEn: "9.2 km — Longest — 7 recorded deaths" },
  { id:  3, name: "Platanal",       area: "Soledad Sur",              lat: 10.9035, lng: -74.7853, desc: "6.8 km — 4 muertes — Barrio Ferrocarril / CAI Soledad", descEn: "6.8 km — 4 deaths — Ferrocarril / CAI Soledad", photos: {
    clear:   "/zones/3-clear.jpg",
    caution: "/zones/3-caution.jpg",
    danger:  "/zones/3-danger.jpg",
  } },
  ...
  { id:  5, name: "Santo Domingo",  area: "Suroccidente",             lat: 10.9586, lng: -74.818, desc: "Afluente del arroyo León", descEn: "Tributary of arroyo León" },
  { id:  6, name: "Coltabaco",      area: "Centro-Oeste",             lat: 10.98861, lng: -74.77993, desc: "3.8 km — Caudal 28 m³/s — Hacia Vía 40", descEn: "3.8 km — Flow 28 m³/s — Toward Vía 40", photos: {
  ...
  { id:  9, name: "Calle 94",       area: "Norte",                    lat: 11.0192, lng: -74.808, desc: "1.4 km — Zona norte", descEn: "1.4 km — Northern zone", photos: {
    clear:   { dawn: "/zones/9-clear-day.jpg",   day: "/zones/9-clear-day.jpg",   sunset: "/zones/9-clear-sunset.jpg",   night: "/zones/9-clear-night.jpg" },
    caution: { dawn: "/zones/9-caution-day.jpg", day: "/zones/9-caution-day.jpg", sunset: "/zones/9-caution-sunset.jpg", night: "/zones/9-caution-night.jpg" },
    danger:  { dawn: "/zones/9-danger-day.jpg",  day: "/zones/9-danger-day.jpg",  sunset: "/zones/9-danger-sunset.jpg",  night: "/zones/9-danger-night.jpg" },
  } },

  // === SUROCCIDENTE NETWORK ===
  { id: 10, name: "Las Américas",   area: "Suroccidente",             lat: 10.9558, lng: -74.811, desc: "Red barrial — Las Américas, La Ceibita", descEn: "Neighborhood network — Las Américas, La Ceibita" },
  ...
  // === NORTE ===
  { id: 13, name: "Carrera 70",     area: "Norte",                    lat: 11.01868, lng: -74.818, desc: "", descEn: "" },
];
