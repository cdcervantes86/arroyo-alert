...
export const ZONES = [
  ...
  { id: 1,  name: "Don Juan",       area: "Sur / Soledad",       lat: 10.9355, lng: -74.7980, desc: "7.9 km — Caudal 85 m³/s — Desemboca cerca del Ferry", descEn: "7.9 km — Flow 85 m³/s — Empties near El Ferry" },
  { id: 2,  name: "El Salao",       area: "Villa Angelita",      lat: 10.955, lng: -74.815, desc: "9.2 km — El más largo de la ciudad", descEn: "9.2 km — Longest in the city" },
  { id: 3,  name: "Platanal",       area: "Soledad",             lat: 10.935, lng: -74.795, desc: "6.8 km — Ciudadela Metropolitana / Cinco Bocas", descEn: "6.8 km — Ciudadela Metropolitana / Cinco Bocas", photos: { clear: "/zones/3-clear.jpg", caution: "/zones/3-caution.jpg", danger: "/zones/3-danger.jpg" } },
  { id: 4,  name: "El Bosque",      area: "Suroccidente",        lat: 10.96, lng: -74.81, desc: "Red de arroyos del suroccidente", descEn: "Southwest arroyo network" },

  // === ACTIVE — still dangerous ===
  { id: 5,  name: "Santo Domingo",  area: "Suroccidente",        lat: 10.958, lng: -74.818, desc: "Afluente del arroyo León", descEn: "Tributary of arroyo León" },
  { id: 6,  name: "Coltabaco",      area: "Centro-Oeste",        lat: 10.975, lng: -74.8, desc: "3.8 km — Caudal 28 m³/s", descEn: "3.8 km — Flow 28 m³/s" },
  { id: 7,  name: "La Paz",         area: "Cra 40",              lat: 10.972, lng: -74.793, desc: "2.9 km — Caudal 21 m³/s", descEn: "2.9 km — Flow 21 m³/s" },
  { id: 8,  name: "Carrera 8",      area: "Barrio Abajo",        lat: 10.98, lng: -74.783, desc: "3.4 km — Hacia Vía 40", descEn: "3.4 km — Toward Vía 40" },
  { id: 9,  name: "Calle 94",       area: "Norte",               lat: 11.002, lng: -74.815, desc: "1.4 km — Zona norte", descEn: "1.4 km — Northern zone", photos: {
  ...
  { id: 10, name: "Las Américas",   area: "Suroccidente",        lat: 10.956, lng: -74.812, desc: "Red barrial — Las Américas, La Ceibita", descEn: "Neighborhood network — Las Américas, La Ceibita" },
  { id: 11, name: "La Chinita",     area: "Caño La Ahuyama",     lat: 10.95, lng: -74.805, desc: "Zona inundable cerca del caño", descEn: "Flood-prone area near the canal" },
  { id: 12, name: "Los Ángeles",    area: "Suroccidente",        lat: 10.954, lng: -74.82, desc: "Calle 115 con Cra 16 — Escorrentías barriales", descEn: "Calle 115 & Cra 16 — Neighborhood runoff" },
];
