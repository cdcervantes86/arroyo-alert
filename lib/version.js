...
export const CHANGELOG = [
  {
    version: "0.11.0",
    date: "2026-04-13",
    title: { es: "Diseño de cristal y fotos de zona", en: "Glass design & zone photos" },
    items: {
      es: [
        "✨ Diseño de cristal — navegación, encabezado y paneles con efecto vidrio",
        "🏙️ Fotos por zona — cambian según estado del arroyo y hora del día",
        "📱 Barra flotante — píldora de cristal con botón de reporte central",
        "👤 Página Sobre — misión, privacidad, cómo funciona y contacto",
        "🗑️ Eliminar reporte — borra tus propios reportes",
        "💬 Sugerencias rápidas — frases predefinidas al reportar",
        "📊 Tus reportes en Perfil — últimos 5 con zona y severidad",
        "👍 Confirmaciones en lista — conteo de upvotes visible",
        "🔴 Indicador en Mapa — número de zonas en peligro",
        "🌧️ Reportar desde alerta de lluvia",
      ],
      en: [
        "✨ Glass design — nav, header and panels with frosted glass effect",
        "🏙️ Zone photos — change based on arroyo state and time of day",
        "📱 Floating nav pill — glass capsule with centered report button",
        "👤 About page — mission, privacy, how it works and contact",
        "🗑️ Delete report — remove your own reports",
        "💬 Quick suggestions — preset phrases when reporting",
        "📊 Your reports in Profile — last 5 with zone and severity",
        "👍 Confirmations on list — upvote count visible",
        "🔴 Map tab badge — danger zone count",
        "🌧️ Report from rain alert",
      ],
    },
    bugfixes: {
      es: [
        "Ubicación solo al presionar el botón, no al abrir la app",
        "Leyenda del radar coincide con colores reales",
        "Icono de precaución rediseñado como gota de agua",
        "Parpadeo corregido al desplazar en modales",
        "Controles del mapa visibles sobre la navegación",
        "Cerrar zona tocando espacio vacío en lista",
      ],
      en: [
        "Location only requested on button press, not on app open",
        "Rain radar legend matches actual tile colors",
        "Caution icon redesigned as water drop",
        "Scroll flicker fixed in modals",
        "Map controls visible above navigation",
        "Dismiss zone sheet by tapping empty space in list",
      ],
    },
  },
  {
