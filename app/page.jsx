...
function AppContent() {
  ...
  if ((screen === "profile" || closingMobile === "profile") && !isDesktop) return <div style={{ animation: closingMobile === "profile" ? "screenSlideOut 0.25s ease forwards" : "screenSlideIn 0.3s cubic-bezier(0.32, 0.72, 0, 1)", position: "fixed", inset: 0, zIndex: 50, background: "#0a0f1a", backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", overflowY: "auto" }}><ReporterProfile reports={reports} onBack={closeMobileScreen} onLogoClick={handleLogoClick} onToggleLang={toggleLang} lang={lang} /></div>;
